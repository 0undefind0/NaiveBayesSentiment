...
text = "been using this buds for 2 weeks na and I notice that sometimes it took so long to connect on my laptop and phone I don't know why. then sometimes nagkaproblem sound nya parang basag yung tunog"
result = predict(text)
